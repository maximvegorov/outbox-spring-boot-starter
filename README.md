...
|----------------------------|---------------|--------------------------------------------------------|
| `outbox.messages.published` | `handlerType` | Количество опубликованных сообщений                    |
| `outbox.messages.processed` | `handlerType` | Количество успешно обработанных сообщений              |
| `outbox.messages.error`     | `handlerType` | Количество сообщений, переведённых в статус `ERROR`    |
